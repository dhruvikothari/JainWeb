...
<html class="no-js" lang="zxx">
    ...
    <body>
				...
				<div class="single-slider" style="background-image:url('img/slider3.png')">
					<div class="container">
						<div class="row">
							<div class="col-lg-7">
								<div class="text">
									<h1>We Help <span>YOU</span> Grow!</span></h1>
									<p>A human in need is always helped at our door step. </p>
									<div class="button">
										<a href="#" class="btn">Get Paramseva</a>
				...
				<div class="single-slider" style="background-image:url('img/slider3.png')">
					<div class="container">
						<div class="row">
							<div class="col-lg-7">
								<div class="text">
									<h1>We Help <span>YOU</span> Grow!</h1>
									<p>A human in need is always helped at our door step. </p>
									<div class="button">
										<a href="#" class="btn">Get Paramseva</a>
		...
		<!-- Start Paramseva -->
		<section class="Paramseva">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<div class="section-title">
							<br>
							<h2>We Are Always Ready to Help You. Book An Paramseva</h2>
					...
					<div class="col-lg-6 col-md-12 col-12">
						<form class="form" action="#">
							<div class="row">
								...
								<div class="col-lg-6 col-md-6 col-12">
									<div class="form-group">
										<div class="nice-select form-control wide" tabindex="0"><span class="current">Service Type</span>
											<ul class="list">
												<li data-value="1" class="option selected ">Type</li>
												<li data-value="2" class="option">Tiffin Service</li>
												<li data-value="3" class="option">JeevDaya</li>
												<li data-value="4" class="option">Ambiyal House</li>
												<li data-value="5" class="option">Others</li>
											</ul>
										</div>
									</div>
								</div>
								<div class="col-lg-6 col-md-6 col-12">
									<div class="form-group">
										<div class="nice-select form-control wide" tabindex="0"><span class="current">Helpaid</span>
							...
							<div class="row">
								<div class="col-lg-5 col-md-4 col-12">
									<div class="form-group">
										<div class="button">
											<button type="submit" class="btn">Book An Paramseva</button>
										</div>
									</div>
								</div>
				...
				<div class="row ">
					<div class="col-lg-6  col-12">
						...
						<div class="subscribe-text ">
							...
							<p class="">Sign up to our newsletter to get allour news in your inbox.</p>
						</div>
						<!-- End Newsletter Form -->
					</div>
					<div class="col-lg-6  col-12">
