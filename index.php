...
<html class="no-js" lang="zxx">
    ...
    <body>
						...
						<div class="row">
							<div class="col-lg-7">
								<div class="text">
									...
									<div class="button">
										<a href="#" class="btn">Get Arhamseva</a>
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="section-title">
							<h2>Spreading the Colours of Humanity”</h2>
		...
		<!-- Start Arhamseva -->
		<section class="Arhamseva">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<div class="section-title">
							<br>
							<h2>We Are Always Ready to Help You. Book An Arhamseva</h2>
							<img src="img/section-img.png" alt="#">
							<p>Lorem ipsum dolor sit amet consectetur adipiscing elit praesent aliquet. pretiumts</p>
						</div>
					</div>
						...
						<form class="form" action="#">
							...
							<div class="row">
								<div class="col-lg-5 col-md-4 col-12">
									<div class="form-group">
										<div class="button">
											<button type="submit" class="btn">Book An Arhamseva</button>
										</div>
									</div>
								</div>
